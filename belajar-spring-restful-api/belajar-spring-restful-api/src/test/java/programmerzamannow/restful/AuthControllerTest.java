...
public class AuthControllerTest {
    ...
    @Test
    public void loginFailedUserWrongPassword() throws Exception {
        User user = new User();
        user.setName("Test");
    ...
    public void loginSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            WebResponse<TokenRespose> response = objectMapper.readValue(result.getResponse().getContentAsString(), new TypeReference<>() {
            });
