...
public class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception{
        ...
        mockMvc.perform(
            ...
            assertEquals("Khaneddy", response.getData().getLastName());
            assertEquals("eko@example.com", response.getData().getEmail());
            assertEquals("08123651723", response.getData().getPhone());
    ...
    @Test
    void getContactSucess() throws Exception{
        ...
        contact.setLastName("Khaneddy");
        contact.setEmail("eko@example.com");
        contact.setPhone("12312441");
    ...
    @Test
    void deleteContactSucess() throws Exception{
        User user = userRepository.findById("test").orElseThrow();
    ...
    @Test
    void searchContactUsingName() throws Exception{
        User user = userRepository.findById("test").orElseThrow();
    ...
    @Test
    void searchContactEmailSuccess() throws Exception{
        User user = userRepository.findById("test").orElseThrow();
    ...
    @Test
    void searchContactPhoneSuccess() throws Exception{
        User user = userRepository.findById("test").orElseThrow();
